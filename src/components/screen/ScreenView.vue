  ...
  <div>
    ...
    <el-tooltip class="item" effect="dark" content="刷新" placement="bottom">
      <el-button
        ...
        circle
        @click="getList"
        style="position: fixed; left: 220px; top: 60px"
      ></el-button>
    </el-tooltip>
    <el-tooltip class="item" effect="dark" content="截屏" placement="bottom">
      <el-button
        ...
        circle
        @click="screenCapture"
        style="position: fixed; left: 270px; top: 60px"
      ></el-button>
    </el-tooltip>
    <el-tooltip
      class="item"
    ...
    >
      <el-button
        ...
        style="position: fixed; left: 330px; top: 60px"
      ></el-button>
    </el-tooltip>
    <el-tooltip
      class="item"
    ...
    >
      <el-button
        ...
        style="position: fixed; left: 390px; top: 60px"
      ></el-button>
    </el-tooltip>
    <el-tooltip class="item" effect="dark" content="清除" placement="bottom">
      <el-button
        ...
        circle
        @click="clean"
        style="position: fixed; left: 450px; top: 60px"
      ></el-button>
    </el-tooltip>
