<template>
    <div>
        ...
        <el-tooltip class="item" effect="dark" content="刷新" placement="bottom">
            <el-button icon="el-icon-refresh" circle @click="getList" style="position: fixed; left: 20px; top: 80px"></el-button>
        </el-tooltip>
        <el-tooltip class="item" effect="dark" content="截屏" placement="bottom">
            <el-button icon="el-icon-camera" circle @click="screenCapture" style="position: fixed; left: 70px; top: 80px"></el-button>
        </el-tooltip>
        <el-tooltip class="item" effect="dark" content="开始录屏" placement="bottom">
            <el-button icon="el-icon-video-camera" circle @click="startScreenRecording" style="position: fixed; left: 130px; top: 80px"></el-button>
        </el-tooltip>
        <el-tooltip class="item" effect="dark" content="结束录屏" placement="bottom">
            <el-button icon="el-icon-switch-button" circle @click="stopScreenRecording" style="position: fixed; left: 190px; top: 80px"></el-button>
        </el-tooltip>
        <el-tooltip class="item" effect="dark" content="清除" placement="bottom">
            <el-button icon="el-icon-delete" circle @click="clean" style="position: fixed; left: 250px; top: 80px"></el-button>
        </el-tooltip>
