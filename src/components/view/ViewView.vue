<template>
  <div style="padding: 20px">
    ...
    <el-tooltip effect="dark" content="开启触摸定位" placement="bottom">
      <el-button
        icon="el-icon-aim"
        @click="handleInstallMonitorView"
        circle
      ></el-button>
    </el-tooltip>
    <el-tooltip effect="dark" content="关闭触摸定位" placement="bottom">
      <el-button
        ...
        @click="handleUnInstallMonitorView"
        circle
      ></el-button>
    </el-tooltip>
    <div class="box" ref="box" style="height: 840px">
          ...
          >
            <el-table-column label="属性名称" width="180" style="padding: 0px">
              <template slot-scope="scope">
                <div :class="attributeLabelStyle(scope.row.type)">
            ...
            <el-table-column label="属性值">
              <template slot-scope="scope">
                <div
                  :class="attributeLabelStyle(scope.row.type)"
      ...
      for (let i = 0; i < resize.length; i++) {
        ...
        resize[i].onmousedown = function (e) {
          ...
          document.onmousemove = function (e) {
            // 这个200是左右的菜单栏的宽度
            var endX = e.clientX - 200;
            var moveLen =
              resize[i].left + (endX - startX) - resize[i].clientWidth; // （endx-startx）=移动的距离。resize[i].left+移动的距离=左边区域最后的宽度
